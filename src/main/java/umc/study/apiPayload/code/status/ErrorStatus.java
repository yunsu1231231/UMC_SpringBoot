...
public enum ErrorStatus implements BaseErrorCode {
    ...
    DUPLICATE_EMAIL(HttpStatus.BAD_REQUEST, "MEMBER4003", "이메일이 중복되었습니다."),
    ...
    INVALID_RATING(HttpStatus.BAD_REQUEST, "REVIEW4002", "평점 값이 유효하지 않습니다."),

    // Mission Errors
    MISSION_NOT_FOUND(HttpStatus.NOT_FOUND, "MISSION4001", "미션을 찾을 수 없습니다."),
    INVALID_MISSION_STATE(HttpStatus.BAD_REQUEST, "MISSION4002", "유효하지 않은 미션 상태입니다."),
